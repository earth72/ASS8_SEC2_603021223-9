...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2019 at 06:10 PM
...
(2, 'mee', 'Female', 'mee@gmail.com', 17000),
(6, 'phokapit', 'Male', 'phokapit_K@kkumail.c', 60000);
...
--
ALTER TABLE `employee`
  MODIFY `emp_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
